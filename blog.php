	...
	<div class="blog_tabs">
		<div class="tabs-section">
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<?php   
					$stmt = $conn->prepare("SELECT * FROM `category` ORDER BY id DESC limit 6");
					$stmt->execute();
					$i=0;
			...
			<div class="tab-content" id="myTabContent">
				...
				<div class="tab-pane fade <?php echo $class ?> postAjaxdata" id="psycho-<?php echo $i ?>" role="tabpanel" aria-labelledby="psycho-<?php echo $i ?>-tab">
					...
					<div class="outerline">
						<button class="" data-id="<?php echo $data_post['id']; ?>" id="viewpost" onclick="viewMoreblog(this)">View More</button>
					</div>
				</div>
				<?php ++$i; } ?>
			</div>
