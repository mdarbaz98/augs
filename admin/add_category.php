								...
								<div class="card">
									<div class="card-body" id="accordion">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="cat_name" name="cat_name" placeholder="Enter Name"> </div>
										<div class="form-group">
											<label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Title</label>
											<input type="text" class="form-control" id="title" name="title" placeholder="SEO Title"> </div>
										<div class="form-group">
