				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box d-sm-flex align-items-center justify-content-between">
							<div>
								<h4 class="mb-sm-0 font-size-18">Add CTA</h4>
							</div>
							...
							<div class="card-body">
								<div class="d-flex  my-4">
									...
									<div class="form-group  w-100">
										...
										<input type="text" class="form-control" id="shrt_dtl" name="shrt_dtl" placeholder="Short Details">
									 </div>
								</div>
								<div class=" d-flex my-4 mx-2">
										...
										<div class="customefeature_image w-75  ml-5"> 
...
<?php
	...
	else { echo "<script>window.location='http://localhost/augs/admin/index.php'</script>";   }
 ?>