...
<div class="main-content">
    ...
    <h4 class="card-title mb-4">Content</h4>                
                ...
                <textarea id="content" name="content" class="form-control" rows="50"><?php echo $row_post['content'] ?></textarea>
    ...
    <div class="title active">Content Title</div>
      <div class="desc active">
        ...
        <input type="text" class="form-control" id="title" name="title" value="<?php echo $row_post['title'] ?>">
        </div>    
        
        <div class="form-group">                          
        <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">SEO Title</label>
        <input type="text" class="form-control" id="seo_title" name ="seo_title" value="<?php echo $row_post['seo_title'] ?>">
        </div>
        
        <div class="form-group">
        <label for="horizontal-email-input" class="col-sm-3 col-form-label">Slug</label> <br>
        <input type="text" class="form-control" id="slug" name ="slug" value="<?php echo $row_post['slug'] ?>">
        </div> 
        <div class="form-group">
        <label class="form-label">Meta Description</label>
         <textarea class="form-control" rows="3" id="meta_desc" name="meta_desc"><?php echo $row_post['description'] ?></textarea>
        </div>
    ...
    <div class="title">Category</div>
       ...
       <div class="form-group">
        ...
        ?><select class="form-control sel_cat" id="category" name="category" title="Please select Category">
            ...
            ?> <option value="<?php echo $data['id']; ?>" <?php if ($data['id'] == $row_post['cat_id']) echo ' selected="selected"'; ?> ><?php echo $data['name']; ?></option>
            <?php } ?>
            </select>
        </div>
    ...
    <div class="form-group">
     <label class="form-label">Description</label>
         <textarea class="form-control" rows="6" id="description" name="description"><?php echo $row_post['description'] ?></textarea>
    </div>
